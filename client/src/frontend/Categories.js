...
function Categories() {
  ...
  return (
    <>
      <div class="bg-gray-100 dark:bg-neutral-700 w-full dark:text-gray-200">
        <div class="border-t-8 border-red-600 w-2/12"></div>
        <h1 class="text-2xl">Categories</h1>
        <div class="border-red-600 border-b-8 w-2/12"></div>
      </div>
      ...
      <div className="relative container gap-1 grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 mx-auto mt-2 cursor-pointer ms-1">
        {categories?.map((category, index) => {
          return (
            <a key={index} href="category.html?category=${Name}">
